...
const features = [
  ...
  },
  {
    ...
    icon: (
      <svg aria-hidden className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
        <path d="M4 19V5M9 19V11M14 19V7M19 19V3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
...
export default function RegisterPage() {
  ...
  return (
    <main className={`${poppins.className} relative min-h-screen overflow-hidden bg-[#0F172A]`}>
      ...
      <section className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-center px-6 py-12 lg:px-12">
        <header className="mb-12 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <FinovaLogo />
          <span className="text-sm font-medium text-emerald-100/80">Plataforma integral de gestión financiera</span>
        </header>

        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
          <div className="space-y-8 text-slate-100">
            <div className="space-y-4">
              <h1 className="text-4xl font-semibold leading-tight md:text-5xl">Impulsa tus finanzas creando tu cuenta Finova</h1>
              <p className="max-w-xl text-lg text-slate-300">
                Crea tu perfil personalizado, configura tus objetivos y comienza a recibir insights accionables para optimizar tu gestión financiera desde el primer día.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/10 p-6 shadow-lg backdrop-blur transition duration-500 hover:border-emerald-300/60 hover:shadow-emerald-400/25">
              <p className="text-xl font-semibold text-emerald-200">“Finova te acompaña en cada decisión”</p>
              <p className="mt-2 text-sm text-slate-200">
                Diseñado para equipos y profesionales que buscan claridad en su flujo financiero con alertas tempranas y recomendaciones inteligentes.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 -left-6 hidden rounded-3xl bg-gradient-to-br from-emerald-500/20 via-emerald-500/5 to-transparent blur-3xl lg:block" aria-hidden />
            <div className="relative rounded-3xl bg-white/95 p-8 shadow-2xl shadow-emerald-500/10 transition duration-500 hover:-translate-y-1 hover:shadow-emerald-500/25 md:p-10">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500">
                  Completa tus datos para comenzar a gestionar presupuestos, gastos e insights personalizados.
                </p>
              </div>
